...
fn main() -> Result<()> {
    ...
    println!("tick,time_s,temperature_K,total_particles,photons,electrons,positrons,quarks,leptons,gluons,w_bosons,z_bosons,compton_total,pair_prod_total");
